...
public class NearbyContainers {
    ...
    public static final List<String> INVENTORY_KEYS = List.of(SHULKER_BOXES);
    public static final List<String> ENTITY_KEYS = List.of(BOAT_CHESTS, CHEST_MINECARTS, HOPPER_MINECARTS, DONKEY_CHESTS, MULE_CHESTS, LLAMA_CHESTS, OTHER_CONTAINERS);
    ...
    private static Container enabledContainerAt(Level level, BlockPos pos) {
